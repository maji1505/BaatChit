  ...
  return (
    <div className='flex flex-col items-center justify-center min-w-80 mx-auto'>
			<div className='w-full p-6 pt-3 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				...
				<form>
 					<div>
 						<label className='label p-2 pb-1' for='fullname'>
 							<span className='text-base label-text'>Full Name</span>
 						</label>
						<input type='text' id='fullname' placeholder='Enter Name' className='w-full input input-bordered  h-10' />
					</div>

					<div>
						<label className='label p-2 pb-1 ' for='username'>
				...
				<div>
						<label className='label p-2 pb-1' for='password'><span className='text-base label-text'>Password</span>
						</label>
						<input
					...
					<div>
						<label className='label p-2 pb-1' for='confirm'>
